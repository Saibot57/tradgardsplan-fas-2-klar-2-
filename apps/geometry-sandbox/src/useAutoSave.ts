...
import { serializeScene, parseScene, migrateScene, SceneParseError, type SceneV6 } from "@kolonitradgard/spatial-core";
 ...
 */
export async function bootstrapFromAdapter(adapter: ScenePersistence): Promise<SceneV6 | null> {
